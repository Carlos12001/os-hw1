...
# ACDS 18.0 614 win32 2024.08.22.15:35:11
# ----------------------------------------
...
alias com {
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/cpu_pio_buzzer.v"                                           -work pio_buzzer                                  
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/cpu_leds_hours_ls.v"                                        -work leds_hours_ls                               
